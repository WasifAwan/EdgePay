            ...
            <div className="col-lg-6 align-self-center">
              <div className="banner-inner pe-xl-5 pt-4 pt-lg-0">
                ...
                <p
                  ...
                  data-wow-delay="0.5s"
                >
                  PayHub simplifies business management, allowing you to easily create, send, and track invoices while enabling quick, hassle-free payments from your customers.
                </p>
                <Link
