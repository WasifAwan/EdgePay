          ...
          <div className="row">
            <div className="col-lg-6 align-self-center">
              <div className="banner-inner pe-xl-5">
                ...
                >
                  {' '}
                  Simplify Payments with <span>PayHub</span> 
                </h2>
                <p
                  ...
                  data-aos-duration="1500"
                >
                  PayHub is a payment platform designed to make online transactions easier for both global and local businesses and their customers. It helps businesses connect with customers by offering a quick, one-click checkout process that is both safe and simple to use. This checkout solution also supports various payment methods, making it convenient for customers to pay in the way they prefer.
                </p>
                <Link
